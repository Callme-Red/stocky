...
export default function SalesFormatPDF({ products = [], customer, department, municipality, codeSale, paymentMethod, date, address, deliveryCost, discount, phone, subTotal, total }: Props) {
  return (
    <Document>
      <Page style={{ paddingVertical: 30 }} size="A4">
        <View style={{ paddingHorizontal: 60, flexDirection: 'row', justifyContent: 'flex-end', alignItems: 'center', backgroundColor: COLORS.whiting2, height: 50, width: "100%" }}>
          <Text style={{ fontSize: 20, textAlign: 'right', color: COLORS.primary, fontWeight: 'bold', fontFamily: 'Roboto' }}>FACTURA</Text>
        </View>
        ...
        <View style={{ justifyContent: 'space-between', flexDirection: 'row', marginTop: 10, paddingHorizontal: 60, width: '100%' }}>
          ...
          <View style={{ marginTop: 10, alignItems: 'flex-end' }}>
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-end' }}>
              <Text style={[styles.text, { textAlign: 'right' }]}>Factura: </Text>
              <Text style={{ fontSize: 13, textAlign: 'right', color: COLORS.primary, fontWeight: 'bold', fontFamily: 'Roboto' }}> {codeSale}</Text>
            </View>

            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-end', marginTop: 5 }}>
              <Text style={[styles.text, { textAlign: 'right' }]}>Metodo de pago: </Text>
              <Text style={{ fontSize: 13, textAlign: 'right', color: COLORS.primary, fontWeight: 'bold', fontFamily: 'Roboto' }}> {paymentMethod}</Text>
            </View>

            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-end', marginTop: 5 }}>
              <Text style={[styles.text, { textAlign: 'right' }]}>Vendedor: </Text>
              <Text style={{ fontSize: 13, textAlign: 'right', color: COLORS.primary, fontWeight: 'bold', fontFamily: 'Roboto' }}> Alejandra Barillas</Text>
            </View>
