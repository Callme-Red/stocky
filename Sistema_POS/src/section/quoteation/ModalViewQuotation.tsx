...
export default function ModalViewQuotation({ phone, address, date, department, municipality, onClose, products = [], deliveryCost, discount, subTotal, total, codeQuotation, customer }: Props) {
        ...
        <div className="relative w-full max-w-[1000px] h-[95%] flex flex-col bg-white rounded-xl">
          <div className="relative flex flex-col h-full">
            <div className="flex items-center justify-between bg-[#f3f3f3] p-4 md:px-5 md:py-2 border-b rounded-t-xl border-gray-200">
              <h3 className="text-base font-semibold text-secondary">Detalles de cotización {codeQuotation}</h3>
              <button
                onClick={onClose}
                type="button"
            ...
            <div className="flex-grow py-5 overflow-y-auto px-4">
              <div className="flex items-center space-x-3 mb-5">
                <FieldInput name="Fecha" value={date.toLocaleDateString()} id="date" className="w-full" classNameInput="h-10" readonly />
                <FieldInput name="Cliente" value={customer} id="customer" className="w-full" classNameInput="h-10" readonly />
                <FieldInput name="Codigo" value={codeQuotation} id="codeQuotation" className="w-full" classNameInput="h-10" readonly />
              </div>

              <div className="flex items-center space-x-3 mb-5">
                <FieldInput name="Departamento" value={department} id="department" className="w-full" classNameInput="h-10" readonly />
                <FieldInput name="Municipio" value={municipality} id="municipality" className="w-full" classNameInput="h-10" readonly />
                <FieldInput name="Dirección" value={address} id="address" className="w-full" classNameInput="h-10" readonly />
              </div>
