...
const BestBuyingProducts = ({ products = [], startDate, endDate }: { products: BestBuyingProductsProps[], startDate: string, endDate: string }) => {
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          ...
          <View>
            <Text>Productos mas comprados</Text>
        ...
        <View style={styles.table}>
          ...
          {products && products.map(({ CodigoProducto, NombreProducto, total_spent, total_quantity }, index) => (
...
export default BestBuyingProducts;
